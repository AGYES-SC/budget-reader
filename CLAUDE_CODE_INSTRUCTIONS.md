Replace the entire contents of budget_parser.py with the following. Do not modify anything — copy it exactly as written.

After replacing the file:
1. Run: git add budget_parser.py
2. Run: git commit -m "Force clean parser — remove all capital project noise"
3. Run: git push origin main

--- BEGIN budget_parser.py ---
...
# Matches "TOTAL - DEPARTMENT OF EDUCATION" style headers.
...
# Matches a TOTAL row with figures, with optional leading line number
...
def extract_budget_data(pdf_path: str) -> dict:
    ...
    # Detect the two primary fiscal year columns
    fiscal_years = []
    ...
    # Entities to skip — grand summaries, not discrete appropriations
    ...
    while i < len(full_text_lines):
        ...
        if m:
            ...
            # Scan next 20 lines for the all-funds TOTAL row.
            # Always take the rightmost N numbers (N = fiscal year count)
            # to safely drop any prior-year columns regardless of how many exist.
            found = {}
