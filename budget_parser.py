...
def extract_budget_data(pdf_path: str) -> dict:
    ...
    system_prompt = (
        ...
        "sheriffs' programs, police funds, jail commissions, corrections facilities, etc. "
        ...
        "routed THROUGH a department that already has its own larger total line "
        "(e.g. 'Boys and Girls Clubs of Alabama' listed as a sub-item under "
        "'Human Resources, Department Of' which already has a department-level total)\n"
